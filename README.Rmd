...
Calculate the VGVI for a 200 meters radius around the observers position at 1.7 meters height (eye level).
...
The output of \~0.67 indicates, that \~67% of the visible area, within a 200 meters radius, is covered by greenspace.
...
```{r eval=FALSE, fig.height=4, fig.width=8, message=FALSE, warning=FALSE}
